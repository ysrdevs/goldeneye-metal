...
#endif
#if REX_PLATFORM_MAC
// macOS presents via CAMetalLayer / VK_EXT_metal_surface under MoltenVK.
  ...
  if (paint_context_.swapchain == VK_NULL_HANDLE) {
    ...
    switch (surface_type) {
      ...
      case Surface::kTypeIndex_CAMetalLayer: {
        auto& metal_layer_surface =
            static_cast<const MacOSMetalLayerSurface&>(new_surface);
        VkMetalSurfaceCreateInfoEXT surface_create_info;
        surface_create_info.sType = VK_STRUCTURE_TYPE_METAL_SURFACE_CREATE_INFO_EXT;
        surface_create_info.pNext = nullptr;
        surface_create_info.flags = 0;
        surface_create_info.pLayer =
            static_cast<const CAMetalLayer*>(metal_layer_surface.metal_layer());
