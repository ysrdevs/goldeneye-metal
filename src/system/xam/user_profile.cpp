...
REXCVAR_DEFINE_STRING(ge_username, "User", "Online",
                      "Your in-game name / gamertag (max 15 chars). Set this for online play.");
...
UserProfile::UserProfile() {
  ...
  {
    std::string uname = REXCVAR_GET(ge_username);
    name_ = uname.empty() ? std::string("User") : uname.substr(0, 15);  // gamertag max 15
  }
