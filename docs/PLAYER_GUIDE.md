...
1. Download the current DMG from the
   [GitHub release page](https://github.com/ysrdevs/goldeneye-metal/releases/tag/v0.1.0).
2. Open the DMG.
...
Version 0.1.0 is an experimental development release. It reaches the menu, Dam briefing, and first
