...
```text
release/GoldenEye-Metal-0.1.3-macos-arm64.zip
release/GoldenEye-Metal-0.1.3-macos-arm64.dmg
```
...
Quit all end the process without Force Quit or a lingering unresponsive Dock
process. Do not modify any file inside the app after it has been signed.
