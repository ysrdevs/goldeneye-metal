...
class Shader {
 public:
  ...
  bool writes_position() const { return writes_position_; }
  ...
  uint32_t allocated_color_targets() const { return allocated_color_targets_; }
  uint32_t explicit_color_targets() const { return explicit_color_targets_; }
 ...
 protected:
  ...
  bool writes_position_ = false;
  uint32_t writes_point_size_edge_flag_kill_vertex_ = 0;
  uint32_t writes_color_targets_ = 0b0000;
  uint32_t allocated_color_targets_ = 0b0000;
  uint32_t explicit_color_targets_ = 0b0000;
